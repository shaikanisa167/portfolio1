...
import AlternatePDFViewer from "../Layout/AlternatePDFViewer";
import {
  PDF_DATA,
  PDF_CONFIG,
  formatResumeSection,
...
function ResumeWithPDF() {
  const [isVisible, setIsVisible] = useState(false);
  const [activeTab, setActiveTab] = useState("overview");
  const [pdfViewerType, setPdfViewerType] = useState("alternate"); // 'simple', 'advanced', 'alternate'
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      ...
      case "experience":
        return (
          <div className="space-y-6">
            {formatResumeSection(resumeData.experience, "experience").map(
              (exp) => (
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {exp.technologies.map((tech, index) => (
                        <span
                          key={index}
                          className="bg-slate-700 text-sky-400 px-2 py-1 rounded text-sm"
                        >
                          {tech}
                        </span>
                      ))}
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="card">
              ...
              {Object.entries(skillsData.categorized).map(
                ([category, skills]) => (
      ...
      case "projects":
        return (
          <div className="space-y-6">
            {formatResumeSection(resumeData.projects, "projects").map(
              (project) => (
            ...
            {pdfViewerType === "advanced" && (
              <PDFViewer
                ...
                onError={(error) => {
                  ...
                  // Auto-fallback to alternate viewer on error
                  setPdfViewerType("alternate");
                }}
              />
            )}
          </div>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-16 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            GiaSi <span className="blue-gradient-text">Resume</span>
          </h1>
          <div className="w-24 h-1 bg-sky-500 mx-auto mb-8"></div>
          <p className="text-slate-300 max-w-2xl mx-auto">
            Comprehensive overview of my professional experience, education, and
            skills. All data is dynamically loaded from structured PDF content.
          </p>
          <div className="mt-6">
            <a
