    ...
    <nav className={`fixed w-full z-20 transition-all duration-300 ${
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex md:items-center md:space-x-8">
            ...
            <NavLink to="/projects" active={location.pathname === "/projects"} label="Projects" />
            <NavLink to="/blog" active={location.pathname === "/blog"} label="Blog" />
            <NavLink to="/contact" active={location.pathname === "/contact"} label="Contact" />
            <NavLink to="/resume" active={location.pathname === "/resume"} label="Resume" />
      ...
      >
        <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
          <MobileNavLink to="/" icon={<FaHome className="mr-2" />} label="Home" onClick={closeNavbar} />
          <MobileNavLink to="/about" icon={<FaUser className="mr-2" />} label="About" onClick={closeNavbar} />
          <MobileNavLink to="/projects" icon={<FaLaptopCode className="mr-2" />} label="Projects" onClick={closeNavbar} />
          <MobileNavLink to="/blog" icon={<FaBlog className="mr-2" />} label="Blog" onClick={closeNavbar} />
          <MobileNavLink to="/contact" icon={<FaEnvelope className="mr-2" />} label="Contact" onClick={closeNavbar} />
          <MobileNavLink to="/resume" icon={<FaFile className="mr-2" />} label="Resume" onClick={closeNavbar} />
        </div>
