    ...
    () => [
      {
        ...
        excerpt:
          "Learn how to create fully responsive websites quickly and efficiently using TailwindCSS utility classes.",
        ...
        coverImage:
          "https://placehold.co/600x400/0f172a/0ea5e9?text=TailwindCSS",
      ...
      },
      {
        ...
        excerpt:
          "Discover how to incorporate 3D graphics into your web projects using the powerful Three.js library.",
        content: "Full article content goes here...",
        date: "April 28, 2025",
        readTime: 8,
        author: "Gia Si",
      ...
      },
      {
        ...
        excerpt:
          "Tips and techniques to improve your React application performance and provide a smoother user experience.",
        content: "Full article content goes here...",
        date: "April 10, 2025",
        readTime: 6,
        author: "Gia Si",
      ...
      },
      {
        ...
        excerpt:
          "Learn how to create smooth, professional animations using the GSAP library in your web projects.",
        content: "Full article content goes here...",
        date: "March 22, 2025",
        readTime: 7,
        author: "Gia Si",
      ...
      },
      {
        ...
        excerpt:
          "Step-by-step guide to creating a modern developer portfolio using React and Vite build tools.",
        content: "Full article content goes here...",
        date: "March 5, 2025",
        readTime: 10,
        author: "Gia Si",
      ...
      },
      {
        ...
        excerpt:
          "Explore the latest CSS features and techniques that can improve your web development workflow.",
        content: "Full article content goes here...",
        ...
        category: "CSS",
        coverImage:
          "https://placehold.co/600x400/0f172a/0ea5e9?text=Modern+CSS",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-slate-600 dark:text-slate-300 max-w-2xl mx-auto">
            ...
            technology. Sharing knowledge and experiences from my journey as a
            developer.
          </p>
        </div>
